  ...
  return (
    <>
      <div className="d-grid gap-2 d-sm-flex justify-content-sm-center">
        <button type="button" className="btn btn-primary  gap-3" onClick={handleIncrement}>+1</button>
      ...
      <div className="d-grid gap-2 d-sm-flex justify-content-sm-center my-gap">
        <input type="text" ref={inputElement} className="my-input-box" placeholder='Enter number' />
